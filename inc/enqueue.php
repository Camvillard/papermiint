...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script( 'intro-scripts', get_template_directory_uri() . '/js/intro.js', array(), $theme_version, true);
		wp_enqueue_script( 'intro-slider', get_template_directory_uri() . '/js/intro-slider.js', array(), $theme_version, true);
